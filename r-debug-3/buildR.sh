...
if [[ $# -eq 0 ]]; then
    ...
    # http://www.stats.ox.ac.uk/pub/bdr/memtests/README.txt
    # https://github.com/rocker-org/r-devel-san/blob/master/Dockerfile
    export CC="clang -fsanitize=address -fno-sanitize=undefined -fno-sanitize=float-divide-by-zero -fno-sanitize=alignment -fno-omit-frame-pointer"
    export CXX="clang++ -fsanitize=address -fno-sanitize=undefined -fno-sanitize=float-divide-by-zero -fno-sanitize=alignment -fno-omit-frame-pointer -frtti"
    export CFLAGS="-g -O0 -Wall -pedantic"
    export FFLAGS="-g -O0"
    export CXXFLAGS="-g -O0 -Wall -pedantic"
    export MAIN_LD="clang++ -fsanitize=address -fno-sanitize=undefined"
